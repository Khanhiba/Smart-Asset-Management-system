...
import { maintenanceInput, maintenanceResolution } from '../utils/validation.js';
...
router.get('/', asyncRoute(async (req, res) => {
  const query = {}; if (req.query.status) query.status = req.query.status; if (req.query.priority) query.priority = req.query.priority;
